...
const About = () => {
    ...
    return (
        <div className="about-container">
            ...
            <h1>About Amity</h1>
            <p>I'm a professional rock climber. I live as a nomad, traveling to climbing destinations throughout the western US. Our home: a cargo van my husband and I built out nearly 5 years ago.</p>
